...
class android_threads():
    ...
    def getThreads(self, tList, memList):
        ...
        #print "tls32_index " + str(tls32_index)

        thread_id_index = get_index('tls_32bit_sized_values', 'tid')
        #print "thread_id_index " + str(thread_id_index)

        tlsPtr_index = get_index('Thread', 'tlsPtr_')
        #print str(types.get('Thread')[1].get('tlsPtr_')[0])
        #print "tlsPtr_index " + str(tlsPtr_index)
